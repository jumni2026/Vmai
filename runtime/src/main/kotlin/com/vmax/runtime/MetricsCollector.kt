 ...
 *
 * Platform-independent contract for collecting and aggregating execution metrics.
 *
 * Responsibilities:
...
interface MetricsCollector {
     ...
     */
    fun stopMetrics(sessionId: String, status: String)
     ...
     */
    fun getSessionMetrics(sessionId: String): SessionMetrics?
